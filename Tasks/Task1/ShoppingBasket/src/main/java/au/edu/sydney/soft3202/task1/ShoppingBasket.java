...
public class ShoppingBasket {
    ...
    private String[] names = {"apple", "orange", "pear", "banana"};
    ...
    * Adds an item to the shopping basket.
    ...
    public void addItem(String item, int count) throws IllegalArgumentException {
        ...
        if (!this.items.containsKey(sitem)) throw new IllegalArgumentException("Item " + sitem + " is not present.");
        ...
        this.items.put(sitem, itemVal + count);
    }
